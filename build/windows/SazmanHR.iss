...
[Files]
Source: "{#DistDir}\HRMServer.exe"; DestName: "SazmanHRServerPreflight.exe"; Components: server; Flags: dontcopy noencryption
...
begin
  ...
  begin
    try
      ...
      ExtractTemporaryFile('SazmanHRServerPreflight.exe');
      PreflightExe := ExpandConstant('{tmp}\SazmanHRServerPreflight.exe');
