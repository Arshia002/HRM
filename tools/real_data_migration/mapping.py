...
ALIASES = {
    ...
    "employment_type": ["نوع استخدام", "نوعاستخدام", "وضعیت استخدام", "وضعیتاستخدام", "نوع قرارداد", "نوعقرارداد"],
    "org_unit": ["واحد", "واحد سازمانی", "واحدسازمانی", "محل سازمانی", "محلسازمانی"],
    "location": ["محل خدمت", "محلخدمت", "شهرستان", "محل"],
    "position_no": ["شماره پست سازمانی", "شمارهپستسازمانی", "شماره پست", "شمارهپست", "کد پست", "کدپست"],
    "position_title": ["عنوان پست", "عنوانپست", "عنوان پست سازمانی", "عنوانپستسازمانی", "سمت"],
