...
def main() -> int:
    ...
    print("PASS: HRM v0.7.0-rc.1 organizational-pilot release-hardening gates passed.")
    return 0


if __name__ == "__main__":
    if sys.argv[1:] == ["--dependency-self-check"]:
        print("PASS: v0.7 RC validator direct-import contract")
        raise SystemExit(0)
    if sys.argv[1:] == ["--source-path-self-check"]:
        ...
        print("PASS: v0.7 RC validator clean source-path contract")
        raise SystemExit(0)
