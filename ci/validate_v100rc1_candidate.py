...
def main() -> int:
    ...
    if identity.version != "1.0.0-rc.4" or identity.package_revision != "1.0.0-rc.4-ci.1":
        fail("RC identity is not the approved v1.0 rc.3 ci.2 release identity")
    ...
    print("PASS: HRM v1.0.0-rc.4 final production release-candidate gates passed.")
    return 0
