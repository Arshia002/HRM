...
- افزودن داشبورد وضعیت چارت، تحلیل تحصیلات، وضعیت و سن پرسنل و گزارش‌های مدیریتی.
- افزودن API تجمیعی Privacy-safe بدون بازگرداندن رکورد یا شناسه پرسنلی.
- افزودن Dry Run امن Excel در UI بدون امکان Apply مستقیم روی دیتابیس Production.
- افزودن مدیریت کاربران و ریزدسترسی و جلوگیری Server-side از محدودسازی مالک اصلی.
- یکپارچه‌سازی ممیزی، کاتالوگ پشتیبان، سلامت سیستم و تنظیمات کلاینت.
- افزودن جست‌وجوی سراسری و Navigation مبتنی بر Permission.
- گسترش Frozen UI Smoke برای ساخت و Refresh تمام صفحه‌های مرجع پیش از ساخت Installer.
- حفظ کامل Baseline سبز نصب، TLS، LocalService، ACL، Upgrade، Rollback و چارت ۵۶۸ پستی.
