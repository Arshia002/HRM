...
پاسخ health علاوه بر نسخه و TLS، فقط شناسهٔ غیرمحرمانهٔ استقرار و شمارش‌های تجمیعی کاربران، پرسنل و صفحات چارت را برمی‌گرداند. این مقادیر برای کنترل حفظ دیتابیس در ارتقا استفاده می‌شوند و شامل رکورد، رمز یا کلید نیستند.
