...
نسخهٔ `0.1.0-alpha.1` اولین Baseline مهندسی است. هستهٔ امن و شبکه‌ای پکیج Enterprise مبنا قرار گرفته و بازطراحی رابط کاربری بر اساس Dashboard پکیج دوم در گام‌های بعدی انجام می‌شود.
