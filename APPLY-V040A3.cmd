...
cd /d "%~dp0"
echo [HRM] v0.4.0-alpha.3 isolated local source gates
...
"%HRM_GATE_PYTHON%" ci\validate_v040a3_candidate.py || exit /b 1
"%HRM_GATE_PYTHON%" ci\validate_package_contract.py || exit /b 1
echo PASS: HRM v0.4.0-alpha.3 isolated local source gates passed.
exit /b 0
