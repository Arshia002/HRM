# HRM v1.0.0-rc.4 Release Quality Gates

1. Tested baseline source is commit `8f1adfa88a1b53db1b075504c58900957e812894` (`v0.8.0-rc.1` tested source).
2. Exact final-candidate identity: application `1.0.0-rc.4`, package `1.0.0-rc.4-ci.1`, branch `release/v1.0.0-rc.4`.
...
12. A separate acceptance sequence builds the exact tested v0.8 source and proves real `v0.8.0-rc.1 -> v1.0.0-rc.4` installer upgrade with service, TLS, database and credential preservation.
