...
2. Exact final-candidate identity: application `1.0.0-rc.2`, package `1.0.0-rc.2-ci.7`, branch `release/v1.0.0-rc.2`.
...
12. A separate acceptance sequence builds the exact tested v0.8 source and proves real `v0.8.0-rc.1 -> v1.0.0-rc.2` installer upgrade with service, TLS, database and credential preservation.
