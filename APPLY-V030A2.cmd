...
echo ============================================================
echo   HRM v0.3.0-alpha.2 - native v4.9 shell candidate
echo ============================================================
echo.
...
echo.
echo PASS: HRM v0.3.0-alpha.2 local source gates passed.
echo Next:
echo   git add -A
echo   python ci\validate_package_contract.py --require-git-tracked
echo   git commit -m "feat: add HRM v0.3.0-alpha.2 native v4.9 shell"
...
:fail
echo.
echo ERROR: v0.3.0-alpha.2 validation failed. Do NOT commit or push.
exit /b 1
