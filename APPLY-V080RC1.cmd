...
cd /d "%~dp0"
echo [HRM] v0.8.0-rc.1 production-history and Linux-web release gates
...
"%HRM_GATE_PYTHON%" ci\validate_v080rc1_candidate.py || exit /b 1
"%HRM_GATE_PYTHON%" ci\validate_package_contract.py || exit /b 1
echo PASS: HRM v0.8.0-rc.1 local quality gates passed.
exit /b 0
