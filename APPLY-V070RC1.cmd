...
cd /d "%~dp0"
echo [HRM] v0.7.0-rc.1 organizational-pilot release-hardening gates
...
"%HRM_GATE_PYTHON%" ci\validate_v070rc1_candidate.py || exit /b 1
"%HRM_GATE_PYTHON%" ci\validate_package_contract.py || exit /b 1
echo PASS: HRM v0.7.0-rc.1 local quality gates passed.
exit /b 0
